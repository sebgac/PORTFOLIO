    ...
    <header>
        ...
        <div class="menuGauche">
            ...
            <nav>
                <a>GALERIES PHOTO</a>
                <ul id="categories">
                    <li><a id="voyages" href="#">Voyages <i class="fas fa-arrow-down"></i><i
                                class="fas fa-arrow-up"></i></a>
                        <ul class="continents">
                            <li><a id="asie" href="#">Asie <i class="fas fa-arrow-down"></i><i
                                        class="fas fa-arrow-up"></i></a>
                                <ul class="asie">
                            ...
                            <li><a id="europe" href="#">Europe <i class="fas fa-arrow-down"></i><i
                                        class="fas fa-arrow-up"></i></a>
                                <ul class="europe">
                            ...
                            <li><a id="amsud" href="#">AmSud <i class="fas fa-arrow-down"></i><i
                                        class="fas fa-arrow-up"></i></a>
                                <ul class="amsud">
